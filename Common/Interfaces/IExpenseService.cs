...
namespace Common.Interfaces
{
    ...
    {
        Task<ApiResponseDTO<ExpenseResponseDTO>> AddExpenseAsync(Guid tripId, Guid userId, string? sharingToken, ExpenseCreateDTO createDto);
        ...
        Task<ApiResponseDTO<BudgetSummaryDTO>> GetBudgetSummaryAsync(Guid tripId, Guid userId, string? sharingToken);
